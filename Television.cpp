...
Television::Television(std::string name, Vector2f initialCenterPosition) : StandardObject(name) {
	m_Tag = "television";

	/************************
	***Transform Component***
	************************/
	m_TC = std::make_shared<TransformComponent>(initialCenterPosition, Vector2f(2.5f, 1.5f));
